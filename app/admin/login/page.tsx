      ...
      <div className="w-full max-w-md space-y-6 rounded-2xl bg-white p-8 shadow-sm">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            <h1 className="text-lg font-semibold text-fimo-navy">Admin Login</h1>
            <p className="mt-0.5 text-sm text-gray-500">Masuk untuk kelola platform FimoStay</p>
          </div>
        </div>
        ...
        <form action={signIn} className="flex flex-col space-y-4">
          ...
          <button
            type="submit"
            className="w-full rounded-xl bg-fimo-navy px-4 py-2.5 text-sm font-medium text-white transition-colors hover:bg-fimo-navy/90"
          >
            Masuk
          </button>
