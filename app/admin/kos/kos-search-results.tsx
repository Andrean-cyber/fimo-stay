// app/admin/kos/kos-search-results.tsx
...
export async function KosSearchResults({ query, page: pageParam }: { query: string; page?: string }) {
    ...
    return (
      <div className="rounded-2xl border border-fimo-gray bg-white shadow-sm">
        <EmptyState
          ...
          description={`Tidak ada kos yang cocok dengan "${query}".`}
        />
      </div>
    )
  }
  ...
  return (
    <>
      <p className="text-xs text-gray-500 sm:text-sm">
        Menampilkan {start}–{end} dari {total} kos untuk &quot;{query}&quot;
      </p>
