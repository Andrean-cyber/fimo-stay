    ...
    <div className="min-h-screen bg-[#F8FAF9] text-gray-950">
      ...
      <main>
        ...
        <section className="relative overflow-hidden border-b border-gray-200 bg-white">
          ...
          <div className="relative mx-auto max-w-5xl px-5 pb-12 pt-12 text-center sm:px-6 sm:pb-16 sm:pt-16 lg:pt-20 lg:pb-20">
            {/* Badge */}
            <div className="mx-auto mb-4 inline-flex items-center gap-1.5 rounded-full border border-fimo-navy/15 bg-fimo-navy/[0.04] px-3 py-1.5 text-[11px] font-semibold text-fimo-navy sm:mb-5 sm:text-xs">
